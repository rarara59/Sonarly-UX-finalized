// Fix for unsigned char traits compilation issue in VisionCamera
// This header should be included in the bridging header if needed

#ifndef FIX_UNSIGNED_CHAR_TRAITS_H
#define FIX_UNSIGNED_CHAR_TRAITS_H
...
#endif // FIX_UNSIGNED_CHAR_TRAITS_H