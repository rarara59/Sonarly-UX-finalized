...
private:
  ...
  public:
    ...
    jsi::Value canScheduleExactAlarms(jsi::Runtime &rt) override {
      static_assert(
    ...
    jsi::Value openSettings(jsi::Runtime &rt, jsi::String type) override {
      static_assert(
          bridging::getParameterCount(&T::openSettings) == 2,
          "Expected openSettings(...) to have 2 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::openSettings, jsInvoker_, instance_, std::move(type));
    }
